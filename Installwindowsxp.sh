...
VBoxManage storageattach winxp32 --storagectl "IDE Controller" --type dvddrive --port 1 --device 0 --medium /vbox/iso/w2k3sp2_3959_usa_x64fre_spcd.iso
...
VBoxManage modifyvm winxp32 --dvd /vbox/iso/w2k3sp2_3959_usa_x64fre_spcd.iso
